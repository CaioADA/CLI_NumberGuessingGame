O computador deverá gerar um número entre 1 e 100, e o usuário terá 5 tentativas para acertar, O computador deve mandar de volta se está o valor é menor ou maior q o digitado.
